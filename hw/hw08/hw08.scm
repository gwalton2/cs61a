...
(define (sub-all s olds news)
  (define (corresponding n olds news)
    (if 
      (eq? n (car olds)) (car news)
                           (corresponding n (cdr olds) (cdr news))))
  (define (member? n lst)
    (cond
      ((null? lst) #f)
      ((eq? (car lst) n) #t)
  ...
  (cond 
    ...
    ((member? (car s) olds) (cons (corresponding (car s) olds news) (sub-all (cdr s) olds news)))
